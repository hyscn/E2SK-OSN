...
def main(args):
    ...
    #sparsity_list = [0.7, 0.5, 0.6666666666666666, 0.5249999999999999, 0.8, 0.8333333333333334, 0.6, 0.6124999999999999, 0.6222222222222221, 0.63]
    task_id_sparsity = 0

    # Model Instantiation
    if args.model == "alexnet":
        #model = AlexNet(taskcla, sparsity_list[task_id_sparsity],task_id_sparsity).to(device)
